...
import GetAllCounterSale from "./components/sale/GetCounterSale";
      ...
      <BrowserRouter>
        <Main>
          ...
          <Routes>
            ...
            <Route path='/admin/sale/counter' exact element={<GetAllSale />} />
            ...
            {/*================================================
                       Product sale Permeation add here
               ================================================*/}
            <Route path='/admin/sale/counter/:id' exact element={<GetAllCounterSale />} />

            {/*================================================
                        Counters management
               ================================================*/}
            <Route path='/admin/counters' exact element={<Counters />} />
            <Route path='/admin/counters/:id' element={<CounterDetails />} />
