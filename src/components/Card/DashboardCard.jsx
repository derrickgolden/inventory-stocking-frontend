	...
	return (
		<Fragment>
			<section className='grid md:grid-cols-2 xl:grid-cols-4 gap-6 mt-5 mb-5'>
				<div className='ant-shadow dark:bg-[#2e2d35]   flex items-center p-5 bg-white rounded-lg dashboard-card-bg'>
				...
				{!isCustomer ? (
					...
					<div className='ant-shadow dark:bg-[#2e2d35]  flex items-center p-5 bg-white rounded-lg dashboard-card-bg'>
						<div className='flex items-center bg-transparent dashboard-card-bg'>
							<div className='inline-flex flex-shrink-0 items-center justify-center h-6 w-6 text-indigo-600 bg-indigo-100 rounded-lg mr-6'>
								<FaMoneyBillTransfer size={14} />
							</div>
							<div>
								<span className='block text-2xl font-bold'>
									{" "}
						...
						<div className='ml-auto'>
							<div className='flex flex-column items-center bg-transparent dashboard-card-bg'>
								<div className='inline-flex flex-shrink-0 items-center justify-center h-6 w-6 text-rose-500 bg-rose-100 rounded-lg mr-6'>
									<FaMoneyBillTrendUp size={14} />
								</div>
								<div>
									<span className='block text-2xl font-bold'>
										{" "}
