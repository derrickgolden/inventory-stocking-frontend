...
const Sidenav = () => {
  ...
  const menu = [
    ...
    (hasPermission("create-counter") ||
      hasPermission("readAll-counter")) && {
      label: "COUNTER",
      key: "Counter",
      icon: <MinusSquareOutlined />,
      children: [
        ...
        {
          label: (
            <NavLink to='/admin/shift-bartender'>
              <span>Shift Bartender</span>
            </NavLink>
          ),
          key: "shift-bartender",
          icon: <UserOutlined />,
