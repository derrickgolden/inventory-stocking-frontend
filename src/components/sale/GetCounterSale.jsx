      ...
      <div className='card card-custom mt-2'>
        <div className='card-body '>
            <div className="flex justify-between gap-3">
                ...
                {counter?.singleCounter?.name},{" "}
                <span className="text-lg font-normal text-gray-500 dark:text-gray-800">
                    served by {counter?.singleCounter?.users?.username}
                </span>
                </h2>
                ...
                <div>
                    <CreateDrawer
                        ...
                        >
                            <AddSale 
                                counterId = {id}
                                bartender = {counter?.singleCounter?.users}
                            />
                    </CreateDrawer>
                </div>
            </div>
...
export default GetAllCounterSale;
